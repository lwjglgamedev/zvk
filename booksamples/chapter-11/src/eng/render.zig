...
pub const Render = struct {
    ...
    fn renderFinish(self: *Render, vkCmd: vk.cmd.VkCmdBuff) void {
    ...
    fn renderInit(self: *Render, vkCmd: vk.cmd.VkCmdBuff) void {
        const initBarriers = [_]vulkan.ImageMemoryBarrier2{.{
